...
namespace Caarta.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Type,Id")] Playlist playlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Type,Id")] Playlist playlist)
        {
            if (id != playlist.Id)
            {
                return NotFound();
